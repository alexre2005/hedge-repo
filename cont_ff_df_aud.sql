CREATE OR REPLACE TRIGGER cont_ff_df_aud
  AFTER UPDATE OR DELETE OR INSERT
  ON cont_ff_df
  FOR EACH ROW
/* Auditing cont_ff_df table on the following columns
SEQ_NUMBER
FF_TYPE
ff_formula
*/
